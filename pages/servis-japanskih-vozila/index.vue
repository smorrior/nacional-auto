<template>
  <div class="relative">
    ...
    <div class="relative center justify-center xl:pb-16 xl:px-0 pb-6 px-4 z-10">
      ...
      <h4 class="h4-hero-text md:w-2/3">
        U našem servisu specijalizovani smo za održavanje i popravku japanskih automobila, pružajući visokokvalitetne
        usluge prilagođene potrebama vlasnika svih vodećih japanskih brendova.
      </h4>
  ...
  <div class="section bg-slate-100">
    <div class="center mb-4">
      <h2 class="h2-text xl:mb-12 mb-4">
        Japanski Brendovi Koje Servisiramo
      </h2>
      <h6 class="h6-text">
        ...
        Nudimo kompletnu uslugu za sve popularne japanske brendove
      </h6>
    </div>
...
useHead({
  title: `Servis japanskih vozila - Profesionalni auto servis | Nacional Auto`,
  meta: [
    { name: 'description', content: `Profesionalni servis i održavanje japanskih vozila. Servisiramo sve modele uz originalne delove i kvalitetne popravke.` },
    { name: 'keywords', content: `Auto servis, japanska vozila, dijagnostika, održavanje` },
    { property: 'og:title', content: `Profesionalni servis japanskih vozila` },
    { property: 'og:description', content: `Pružamo vrhunsku uslugu servisa za sve japanske modele, uz stručnost i originalne delove.` },
    { property: 'og:type', content: 'website' },
    { property: 'og:image', content: '/images/nacional-auto-logo.png' },
  ],
  link: [
    { rel: 'canonical', href: `https://www.nacionalauto.com/servis-japanskih-vozila` }
  ],
  script: [
    {
      ...
      json: {
        ...
        "@type": "AutoRepair",
        "name": `Servis japanskih vozila - Nacional Auto`,
        "description": `Profesionalni servis i održavanje japanskih vozila.`,
        "url": `https://www.nacionalauto.com/servis-japanskih-vozila`,
