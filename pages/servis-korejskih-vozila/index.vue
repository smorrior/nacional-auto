<template>
  <div class="relative">
    ...
    <div class="relative center justify-center xl:pb-16 xl:px-0 pb-6 px-4 z-10">
      ...
      <h4 class="h4-hero-text md:w-2/3">
        U našem servisu specijalizovani smo za održavanje i popravku Korejskih automobila, pružajući visokokvalitetne
        usluge prilagođene potrebama vlasnika svih vodećih Korejskih brendova.
      </h4>
  ...
  <div class="section">
    ...
    <div class="second-grid xl:grid-cols-3 grid-cols-2">
      <FlipCard v-for="service in serviceText" :icon="service.icon" :title="service.title"
  ...
  <div class="section bg-slate-100">
    <div class="center mb-4">
      <h2 class="h2-text xl:mb-12 mb-4">
        Korejski Brendovi Koje Servisiramo
      </h2>
      <h6 class="h6-text">
        Naš tim kvalifikovanih i iskusnih tehničara koristi najsavremeniju opremu i originalne ili OEM delove kako bi
        osigurao da vaš automobil radi savršeno, pružajući vam sigurnost i pouzdanost na putu.
        Nudimo kompletnu uslugu za sve popularne korejske brendove
      </h6>
    </div>
    <div class="second-grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 mb-4">
...
useHead({
  title: `Servis korejskih vozila - Profesionalni auto servis | Nacional Auto`,
  meta: [
    { name: 'description', content: `Profesionalni servis i održavanje korejskih vozila. Servisiramo sve modele uz originalne delove i kvalitetne popravke.` },
    { name: 'keywords', content: `Auto servis, kroejska vozila, dijagnostika, održavanje ` },
    { property: 'og:title', content: `Profesionalni servis korejskih vozila` },
    { property: 'og:description', content: `Pružamo vrhunsku uslugu servisa za sve korejske modele, uz stručnost i originalne delove.` },
    { property: 'og:type', content: 'website' },
    { property: 'og:image', content: '/images/nacional-auto-logo.png' },
  ],
  link: [
    { rel: 'canonical', href: `https://www.nacionalauto.com/servis-korejskih-vozila` }
  ],
  script: [
    {
      ...
      json: {
        ...
        "@type": "AutoRepair",
        "name": `Servis za korejska vozila - Nacional Auto`,
        "description": `Profesionalni servis i održavanje korejskih vozila.`,
        "url": `https://www.nacionalauto.com/servis-korejskih-vozila`,
